...
import foodHero from '../../assets/img/foodHero.jpg';
import foodHero2 from '../../assets/img/foodHero2.jpg';

const Food = (props) => {
  return (
    <div className={classes.food}>
      <img src={foodHero2} alt={'Local Food'} className={classes.foodImg}></img>
